...
class generalsettingsController extends Controller {
	...
	public function index(Request $request) {
		...
		return view('backend.generalsettings.edit', compact('stonecollection'));
	...
	public function update($id,Request $request) {
		...
		$this->repository->updategeneralsetting($id, $request);
		//return with successfull message
		return new RedirectResponse(route('admin.generalsettings.index'), ['flash_success' => 'Data updated']);
	}
