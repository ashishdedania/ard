...
namespace App\Http\Controllers\Backend\OutdoorCollectionimage;
...
class outdoorcollectionimageController extends Controller {
	...
	public function index(Request $request) {
		...
		return view('backend.outdoorcollectionimage.edit', compact('stonecollection'));
	...
	public function update($id,Request $request) {
		...
		$this->repository->updateimageoutdoor($id, $request);
		//return with successfull message
		return new RedirectResponse(route('admin.outdoorimage.index'), ['flash_success' => 'Data updated']);
	}
