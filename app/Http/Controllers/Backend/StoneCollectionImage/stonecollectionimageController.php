...
namespace App\Http\Controllers\Backend\StoneCollectionimage;
...
class StonecollectionimageController extends Controller {
	...
	public function index(Request $request) {
		...
		return view('backend.stonecollectionimage.edit', compact('stonecollection'));
	...
	public function update($id,Request $request) {
		...
		$this->repository->updateimage($id, $request);
		//return with successfull message
		return new RedirectResponse(route('admin.collectionimage.index'), ['flash_success' => 'Data updated']);
	}
