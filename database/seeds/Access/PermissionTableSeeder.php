...
class PermissionTableSeeder extends Seeder {
    ...
    public function run() {
        ...
        $viewFrontend->deleted_at = Carbon::now();
        $viewFrontend->save();
        ...
        $viewBackend->created_at = Carbon::now();
        $viewBackend->updated_at = Carbon::now();
        $viewBackend->deleted_at = Carbon::now();
        $viewBackend->save();
         ...
         * create,edit,delete,view permission
         */
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'manage-client';
        $viewBackend->display_name = 'Clients';
        $viewBackend->sort = 48;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'create-client';
        $viewBackend->display_name = 'Create Client';
        $viewBackend->sort = 49;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'edit-client';
        $viewBackend->display_name = 'Edit Client';
        $viewBackend->sort = 50;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'delete-client';
        $viewBackend->display_name = 'Delete Client';
        $viewBackend->sort = 53;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        /**
         * Manage Session
         * create,edit,delete,update permission
         */
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'manage-managesession';
        $viewBackend->display_name = 'Assessments';
        $viewBackend->sort = 54;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'create-managesession';
        $viewBackend->display_name = 'Create Assessment';
        $viewBackend->sort = 55;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'edit-managesession';
        $viewBackend->display_name = 'Edit Assessment';
        $viewBackend->sort = 57;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'delete-managesession';
        $viewBackend->display_name = 'Delete Assessment';
        $viewBackend->sort = 59;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        /**
         * Clinic Services
         * create,edit,update permission
         */
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'manage-clinicalservice';
        $viewBackend->display_name = 'Clinic Services';
        $viewBackend->sort = 60;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'create-clinicalservice';
        $viewBackend->display_name = 'Create Clinic Service';
        $viewBackend->sort = 61;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'edit-clinicalservice';
        $viewBackend->display_name = 'Edit Clinic Service';
        $viewBackend->sort = 62;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        /**
         * Psychological condition type
         * create,edit,update permission
         */
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'manage-psycologicalconditiontype';
        $viewBackend->display_name = 'Psychological Conditions';
        $viewBackend->sort = 63;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'create-psycologicalconditiontype';
        $viewBackend->display_name = 'Create Psychological Condition';
        $viewBackend->sort = 64;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'edit-psycologicalconditiontype';
        $viewBackend->display_name = 'Edit Psychological Condition';
        $viewBackend->sort = 65;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'create-knowledgebase';
        $viewBackend->display_name = 'Create Knowledge Base';
        $viewBackend->sort = 66;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'edit-knowledgebase';
        $viewBackend->display_name = 'Edit Knowledge Base';
        $viewBackend->sort = 68;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'delete-knowledgebase';
        $viewBackend->display_name = 'Delete Knowledge Base';
        $viewBackend->sort = 70;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'manage-knowledgebase';
        $viewBackend->display_name = 'Knowledge Bases';
        $viewBackend->sort = 71;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'change-password';
        $viewBackend->display_name = 'Change Password';
        $viewBackend->sort = 72;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'manage-feedback';
        $viewBackend->display_name = 'Feedbacks';
        $viewBackend->sort = 73;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'manage-questionbank';
        $viewBackend->display_name = 'Question Bank';
        $viewBackend->sort = 60;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'create-questionbank';
        $viewBackend->display_name = 'Create Question';
        $viewBackend->sort = 61;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'edit-questionbank';
        $viewBackend->display_name = 'Edit Question';
        $viewBackend->sort = 62;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'delete-questionbank';
        $viewBackend->display_name = 'Delete Question';
        $viewBackend->sort = 63;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'manage-testimonial';
        $viewBackend->display_name = 'Testimonials';
        $viewBackend->sort = 75;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'view-report-permission';
        $viewBackend->display_name = 'Reports';
        $viewBackend->sort = 76;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'intervention-report';
        $viewBackend->display_name = 'Client Assessment Progress';
        $viewBackend->sort = 77;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        //permission for goal reports
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'progress-report';
        $viewBackend->display_name = 'Goal Progress';
        $viewBackend->sort = 78;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        //permission for Threshold Progress
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'threshold-report';
        $viewBackend->display_name = 'Client NFT Thresholds';
        $viewBackend->sort = 78;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        //permission for SDQ Status
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'sdq-report';
        $viewBackend->display_name = 'SDQ Status';
        $viewBackend->sort = 78;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        //permission for Scared Status
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'scared-report';
        $viewBackend->display_name = 'SCARED Status';
        $viewBackend->sort = 78;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        //permission for Core Status
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'core-report';
        $viewBackend->display_name = 'CORE Status';
        $viewBackend->sort = 78;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'view-masters';
        $viewBackend->display_name = 'Master Management';
        $viewBackend->sort = 4;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'manage-questiontype';
        $viewBackend->display_name = 'Manage Question Type';
        $viewBackend->sort = 79;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'create-questiontype';
        $viewBackend->display_name = 'Create Question Type';
        $viewBackend->sort = 80;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'edit-questiontype';
        $viewBackend->display_name = 'Edit Question Type';
        $viewBackend->sort = 81;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
