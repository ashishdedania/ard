...
mix.sass('resources/assets/sass/frontend/app.scss', 'public/css/frontend.css')
    ...
    .styles([
        ...
        'public/css/star-ratings/theme.css',
        'public/css/star-ratings/star-rating.css',
        'public/css/rangeslider.css',
        'public/css/backend/slider/slider.css',
    ...
    .js([
        ...
        'public/js/star-ratings/theme.js',
        'public/js/star-ratings/LANG.js',
        'public/js/backend/slider/bootstrap-slider.js',
    ], 'public/js/frontend.js')
    .js([
        'resources/assets/js/backend/app.js',
        'resources/assets/js/plugin/sweetalert/sweetalert.min.js',
        'resources/assets/js/plugins.js',
        'public/js/star-ratings/star-rating.js',
        'public/js/backend/slider/rangeslider.js',
    ...
    .scripts([
        ...
        "public/js/actualise.js",
        "public/js/highchart/highcharts.js",
        "public/js/highchart/series-label.js",
        "public/js/highchart/drilldown.js",
        "public/js/highchart/exporting.js",
