            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                            <div class="col-xs-7 col-xs-push-4">
                               <label class="control-label">
                                 ...
                                 I accept {!! link_to_route('frontend.pages.show','Terms and Conditions*', ['page_slug'=>'terms-and-conditions']) !!} </label>
                    ...
                    <div class="form-group">
                            <div class="col-xs-7 col-xs-push-4">
                               <label class="control-label">
                                 {!! Form::checkbox('is_privacy_policy',1,false) !!}
                                 I accept {!! link_to_route('frontend.pages.show', 'Privacy Policy*', ['page_slug'=>'privacy-policy']) !!} </label>
