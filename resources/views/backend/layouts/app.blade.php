...
<html class="no-js" lang="{{ config('app.locale') }}">
    <head>
        ...
        @endif
        {{-- {!! Html::style('css/star-ratings/theme.css') !!} --}}
        {{-- {!! Html::style('css/star-ratings/star-rating.css') !!} --}}
        {{-- {!! Html::style('css/rangeslider.css') !!} --}}
        {{-- {!! Html::style('css/backend/slider/slider.css') !!} --}}
        ...
        <div class="wrapper" id="app">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    @if(Breadcrumbs::exists() && getRoles()->id != env('CLIENT_ROLE_ID'))
