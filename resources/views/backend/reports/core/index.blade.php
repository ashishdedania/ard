...
@section ('title', trans('labels.backend.reports.management') . ' | ' . trans('labels.backend.reports.core.title'))

@section('page-header')
<h1>
    {{ trans('labels.backend.reports.management') }}
    <small>{{ trans('labels.backend.reports.core.title') }}</small>
</h1>
@endsection

@section('content')
{!! Form::open(['route' => 'admin.reports.core.generate', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) !!}
<div class="box box-info">
    <div class="box-header with-border">
        <h3 class="box-title">{{ trans('labels.backend.reports.core.title') }}</h3>
    </div>
    <div class="box-body">
        <div class="form-group">
            {{ Form::label('client_id', trans('labels.backend.reports.core.client'), ['class' => 'col-lg-2 control-label required']) }}
            <div class="col-lg-10">
        ...
        <div class="form-group error-msg" style="display: none;">
            ...
            <div class="col-lg-10">
                <div class="alert alert-danger box-size">No CORE session records found for this client.</div>
            </div>
        </div>
        <div class="form-group">
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        jQuery('#client_id').on('change', function (event) {
            ...
            var result = AJAX.sendRequest("{{route('admin.reports.core.session')}}", "POST", {"clientId": clientId}, function (response) {
                if (response != '[""]') {
