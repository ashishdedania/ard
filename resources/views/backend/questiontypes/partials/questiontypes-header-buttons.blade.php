<!--Action Button-->
@if( Active::checkUriPattern( 'admin/questiontypes' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.questiontypes.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.questiontypes.all' ) }}
            </a>
        </li>
        @permission( 'create-questiontype' )
            <li>
                <a href="{{ route( 'admin.questiontypes.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.questiontypes.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
