<!--Action Button-->
@if( Active::checkUriPattern( 'admin/feedback' ) )
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.feedback.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.feedbacks.all' ) }}
            </a>
        </li>
        @permission( 'create-feedback' )
            <li>
                <a href="{{ route( 'admin.feedback.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.feedbacks.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
