<!--Action Button-->
@if( Active::checkUriPattern( 'admin/knowledgebases' ) )
<div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.knowledgebases.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.knowledgebases.all' ) }}
            </a>
        </li>
        @permission( 'create-knowledgebase' )
        <li>
            <a href="{{ route( 'admin.knowledgebases.create' ) }}">
                <i class="fa fa-plus"></i> {{ trans( 'menus.backend.knowledgebases.create' ) }}
            </a>
        </li>
        @endauth
    </ul>
