<!--Action Button-->
@if( Active::checkUriPattern( 'admin/clinicalservices' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.clinicalservices.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.clinicalservices.all' ) }}
            </a>
        </li>
        @permission( 'create-clinicalservice' )
            <li>
                <a href="{{ route( 'admin.clinicalservices.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.clinicalservices.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
