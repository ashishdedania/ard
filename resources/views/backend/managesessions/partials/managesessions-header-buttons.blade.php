<!--Action Button-->
@if( Active::checkUriPattern( 'admin/managesessions' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.managesessions.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.managesessions.all' ) }}
            </a>
        </li>
        @permission( 'create-managesession' )
            <li>
                <a href="{{ route( 'admin.managesessions.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.managesessions.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
