<!--Action Button-->
@if( Active::checkUriPattern( 'admin/questionbanks' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.questionbanks.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.questionbanks.all' ) }}
            </a>
        </li>
        @permission( 'create-questionbank' )
            <li>
                <a href="{{ route( 'admin.questionbanks.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.questionbanks.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
