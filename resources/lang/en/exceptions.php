...
return [
    "backend" => [
        ...
        "psycologicalconditiontypes" => [
            "already_exists" => "That Psycologicalconditiontype already exists. Please choose a different name.",
            "create_error" => "There was a problem creating this Psycologicalconditiontype. Please try again.",
            "delete_error" => "There was a problem deleting this Psycologicalconditiontype. Please try again.",
            "not_found" => "That Psycologicalconditiontype does not exist.",
            "update_error" => "There was a problem updating this Psycologicalconditiontype. Please try again.",
        ],
        "clinicalservices" => [
            "already_exists" => "That Clinicalservice already exists. Please choose a different name.",
            "create_error" => "There was a problem creating this Clinicalservice. Please try again.",
            "delete_error" => "There was a problem deleting this Clinicalservice. Please try again.",
            "not_found" => "That Clinicalservice does not exist.",
            "update_error" => "There was a problem updating this Clinicalservice. Please try again.",
        ],
        "questionbanks" => [
            "already_exists" => "That Questionbank already exists. Please choose a different name.",
            "create_error" => "There was a problem creating this Questionbank. Please try again.",
            "delete_error" => "There was a problem deleting this Questionbank. Please try again.",
            "not_found" => "That Questionbank does not exist.",
            "update_error" => "There was a problem updating this Questionbank. Please try again.",
        ],
        "clients" => [
        ...
        "managesessions" => [
            "already_exists" => "That session already exists. Please choose a different name.",
            "create_error" => "There was a problem creating this session. Please try again.",
            "delete_error" => "There was a problem deleting this session. Please try again.",
            "not_found" => "That session does not exist.",
            "update_error" => "There was a problem updating this session. Please try again.",
        ],
        "knowledgebases" => [
            "already_exists" => "That Knowledgebase already exists. Please choose a different name.",
            "create_error" => "There was a problem creating this Knowledgebase. Please try again.",
            "delete_error" => "There was a problem deleting this Knowledgebase. Please try again.",
            "not_found" => "That Knowledgebase does not exist.",
            "update_error" => "There was a problem updating this Knowledgebase. Please try again.",
        ],
        "reports" => [
            ...
            "not_found" => "Report for this client does not exist.",
            "update_error" => "There was a problem updating this Report. Please try again.",
        ],
        "feedback" => [
            "already_exists" => "That Feedback already exists. Please choose a different name.",
            "create_error" => "There was a problem creating this Feedback. Please try again.",
            "delete_error" => "There was a problem deleting this Feedback. Please try again.",
            "not_found" => "That Feedback does not exist.",
            "update_error" => "There was a problem updating this Feedback. Please try again.",
        ],
        "testimonials" => [
            "already_exists" => "That Testimonial already exists. Please choose a different name.",
            "create_error" => "There was a problem creating this Testimonial. Please try again.",
            "delete_error" => "There was a problem deleting this Testimonial. Please try again.",
            "not_found" => "That Testimonial does not exist.",
            "update_error" => "There was a problem updating this Testimonial. Please try again.",
        ],
        "questiontypes" => [
            "already_exists" => "That Questiontype already exists. Please choose a different name.",
            "create_error" => "There was a problem creating this Questiontype. Please try again.",
            "delete_error" => "There was a problem deleting this Questiontype. Please try again.",
            "not_found" => "That Questiontype does not exist.",
            "update_error" => "There was a problem updating this Questiontype. Please try again.",
        ],
    ],
    "frontend" => [
        "auth" => [
            "confirmation" => [
                ...
                "resend" => "Your account is not confirmed. Please click the confirmation link in your e-mail, or <a href=http://192.192.7.178:2004/account/confirm/resend/:user_id>click here</a> to resend the confirmation e-mail.",
